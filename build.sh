...
${nuget_cmd} install src/Com.DaDaPush.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Com.DaDaPush.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Com.DaDaPush.Client.dll \
-recurse:'src/Com.DaDaPush.Client/*.cs' \
-doc:bin/Com.DaDaPush.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Com.DaDaPush.Client.dll was created successfully"
fi
